...
import { ROOT_NAME, NodeType, Node, OpNode,OpNodeImpl,  SeriesNode, GroupNode, MetanodeImpl, SeriesGroupingType,
  getStrictName, getGroupSeriesNodeButtonString, getIncludeNodeButtonString} from '../graph';
...
export function _getAllContainedOpNodes(
    nodeName: string, renderGraphInfo:  render.RenderGraphInfo) {
  let opNodes = [];
